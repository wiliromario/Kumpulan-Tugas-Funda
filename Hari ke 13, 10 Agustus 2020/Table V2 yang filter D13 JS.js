// Last Update cek qty di cart apakah melebihi stok atau tidak. Jika lebih maka muncul alert
    ...
    if(arrFilter==0){
        if(arrCart.length>0){
            ...
            if(indexOfCart==-1){
                ...
                console.log(arrCart[indexOfCart].qty)
                console.log(dataProduct[getIndex].stock)
                if(arrCart[indexOfCart].qty>dataProduct[getIndex].stock){
                    console.log("jalan 2")
                    alert(`Maaf stok kami hanya ${dataProduct[getIndex].stock}`)
                    arrCart[indexOfCart].qty-=qty
                }
            }
        }else{
        ...
        if(arrCart.length>0){
            ...
            if(indexOfCart==-1){
                ...
                arrCart[indexOfCart].qty+=qty
                if(arrCart[indexOfCart].qty>arrFilter[indexOfCart].qty){
                    alert(`Maaf stok kami hanya ${arrFilter[getIndex].qty}`)
                    arrCart[indexOfCart].qty-=qty
                }
            }
        }else{
